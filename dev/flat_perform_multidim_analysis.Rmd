...
# `perform_senso_mapping()`: Transform the sensory data to a large format and perform a PCA

With `perform_senso_mapping()`, you can perform the multidimensional analysis of sensory profiles. In practice, a Principal Component Analysis is realized. The graph of individuals (i.e. products) and the graph of variables (i.e. sensory attributes) are displayed in an interactive format.

```{r function-perform_senso_mapping}
#' Transform the sensory data to a large format and perform a PCA
#'
...
perform_senso_mapping <- function(data_profiles,
  ...
  if (isFALSE(is.data.frame(data_profiles))) {
    stop("The data 'data_profiles' you provided is not a dataframe.")
  }
